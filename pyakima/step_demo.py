...
if __name__=='__main__':
    ...
    assert np.allclose(y_akima_scipy1, y_akima_scipy1_actual, atol=1.e-14, rtol=1.e-14)
    ...
    assert np.allclose(y_akima_scipy2, y_akima_scipy2_actual, atol=1.e-14, rtol=1.e-14)
